      ...
      {user ? (
        <>
          <Username>
            ...
            <Emph style={{ color: "#000", marginLeft: 3 }}>
              @{user.username}
            </Emph>
          </Username>
          <Username>
            {`${strings.currentBalance}:`}{" "}
            <Emph style={{ color: "#000", marginRight: 3, marginLeft: 3 }}>
              {user.tokens.toLocaleString(strings.getLanguage()) || 0}{" "}
            </Emph>
            <Image src="/token.svg" alt="token" height={14} width={14} />
          </Username>
          ...
          <NavContent desktop>
            {user ? (
              <TokenContainer>
                <Username>
                  <Emph
                    style={{ color: "#000", fontWeight: 700, marginRight: 3 }}
                  >
                    {user.tokens.toLocaleString(strings.getLanguage()) || 0}
                  </Emph>
                  <Image src="/token.svg" alt="token" height={14} width={14} />
      ...
      <MenuModal visible={menuVisible}>
        {user ? (
          <MenuContent>
            ...
            <ButtonText style={{ color: "#1c1c1c78" }}>
              {strings.currentBalance}:{" "}
              <Emph style={{ color: "#1c1c1c", marginRight: 3, marginLeft: 3 }}>
                {user.tokens.toLocaleString(strings.getLanguage) || 0}{" "}
              </Emph>
              <Image src="/token.svg" alt="token" height={14} width={14} />
            </ButtonText>
