...
export const getUser = () => fire.firestore().collection('users').doc(fire.auth().currentUser.uid).get()
...
export const removeAvatarURL = () => fire.firestore().collection('users').doc(fire.auth().currentUser.uid).update({
  avatarURL: null
})
